...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*parallel-epic" workflow="{project-root}/.bmad/bmm/workflows/4-implementation/parallel-epic-execution/workflow.yaml">Execute entire epic with parallel subagents (Sonnet implements, Opus reviews, SM merges)</item>
